...
Sécurité: veille à la validation d’entrée, gestion JWT/refresh, et protections HTTP
...
export function createServer(): express.Application {
  ...
  // Faire confiance au proxy pour obtenir correctement l'adresse IP du client derrière un proxy
